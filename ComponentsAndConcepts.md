...
Tower of Psych is designed around [classes and objects](http://en.wikipedia.org/wiki/Object-oriented_design).  Classes make it easier to reuse code between similar jobs.  Objects make it easier to break a job into intuitive pieces.

Matlab has supported classes and _handle_ objects since [version 7.6/2008a](http://www.mathworks.com/help/techdoc/matlab_oop/brqzfth-1.html#brqzfth-3).  Tower of Psych requires this version or later.
...
Thanks to the [MATLAB xUnit Test Framework](http://www.mathworks.com/matlabcentral/fileexchange/22846-matlab-xunit-test-framework).

### Documentation ###
Tower of Psych uses [online HTML documentation](http://tower-of-psych.googlecode.com/svn/documentation/html/index.html) generated by Doxygen.  This documentation is rich, cross-linked, and integrated with the base code.  It "knows about" the project's object-oriented design.  Matlab's "help" and "doc" documentation just aren't as good.

Thanks to [Doxygen](http://www.stack.nl/~dimitri/doxygen/).

In order for Doxygen to understand Matlab code, Tower of Psych uses a filter for converting m-code to something resembling C++.  This filter might be useful to other projects, and can be downloaded [here](http://code.google.com/p/tower-of-psych/downloads/detail?name=oom2cpp.zip#makechanges).

### _Fevalable_ Function Calls ###
Tower of Psych defines some jargon for calling functions: an _fevalable_ is a cell array that contains a function\_handle as the first element and function arguments as subsequent elements.  For example, `foo = {@disp, 'abracadabra'}` defines an _fevalable_ called `foo`.
...
The Tower of Psych documentation shows the entire family of _[runnables](http://tower-of-psych.googlecode.com/svn/documentation/html/classtops_runnable.html)_.
...
The GUIs take advantage of some [Undocumented Matlab](http://undocumentedmatlab.com/) features.  These add richness and functionality that are unavailable in regular Matlab GUIs.  Nevertheless, they should work in Matlab "out of the box".
...
### Graphing ###
Tower of Psych provides some utilities for making diagrams and flow charts with the free [GraphViz](http://www.graphviz.org/) program.
